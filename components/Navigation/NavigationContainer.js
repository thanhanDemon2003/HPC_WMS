...
const AppNavigationContainer = () => {
  return (
    <Stack.Navigator screenOptions={{ headerTitleAlign: 'center' }}>
      ...
      <Stack.Screen options={{ gestureEnabled: false, headerTitle: 'Quay lại', headerShown: false, headerStyle: { fontFamily: 'seguisb', color: '#fff', fontSize: 25 } }} name="Bottomtab" component={Bottomtab} />
      ...
      <Stack.Screen options={{
        headerTitle: 'Đổi mật khẩu', headerTintColor: '#00AFCE', headerTitleAlign: 'center', headerStyle: { fontFamily: 'seguisb', color: '#fff', fontSize: 25, },
